    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
            ...
            <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
                        <h1 class="app-page-title">SPP</h1>
				    </div>
                    <div class="col-auto">
                ...
                <div class="card card-nav-tabs">
                    ...
                    ?>
                            ...
                            <td style="text-align: center">
                                <a href="edit_spp.php?id=<?php echo $data['id_spp']; ?>" class="btn btn-warning btn-sm" <?php echo $data['id_spp']; ?>><i class="fas fa-edit"></i></a>
                                <a href="proses/hapus_spp.php?id=<?php echo $data['id_spp']; ?>" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#Modal-hapus"><i class="fas fa-trash"></i></a>
                            </td>
                            </tr>
                        ...
                        <div class="modal fade" id="Modal-hapus" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="proses/hapus_spp.php?id=<?php echo $data['id_spp']; ?>" class="btn btn-primary">Hapus</a>
                                </div>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                            <form action="proses/tambah_spp.php" method="post">
                            <input type="hidden" name="id_spp" value="<?php ['id_spp']; ?>">
                                <div class="form-group mb-3">
                                    <label class="fw-bold">Tahun</label>
                                    <input type="number" name="tahun" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Tahun">
                                </div>
                                <div class="form-group mb-3">
                                    <label class="fw-bold">Nominal</label>
                                    <input type="number" name="nominal" class="form-control" id="exampleFormControlInput1" placeholder="Masukkan Nominal">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
